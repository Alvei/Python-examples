""" dijkstra.py
    Dijkstra's algo solves the single-source shortest path problem. For example,
    finding the lowest cost to any city from a starting city. When it encounters
    a new vertex, it keeps track of how far it is from the starting vertex
    and updates this value.

    Inspired From Classic Computer Science Problems in Python Chapter 4 by David Kopec. """
from __future__ import annotations
from typing import TypeVar, List, Optional, Tuple, Dict
from dataclasses import dataclass
from min_spanning_tree import WeightedPath, print_weighted_path
...
@dataclass
class DijkstraNode:
    """ Simple data structure to keep track of costs associated with each vertex
        explored so far and for comparing them. """
    vertex: int
    distance: float
