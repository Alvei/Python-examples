""" Constraints-statisfaction problems core functionality.
    The default implementation should be overridden.
    Because we are defining the Constraint class as an
    abstract class it will never be instantiated
...
class Constraint(Generic[V, D], ABC):
    """ An asbstract class that will be overridded. """
