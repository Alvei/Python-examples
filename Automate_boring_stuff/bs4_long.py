...
soup = BeautifulSoup(html_doc, "lxml")  # Load the doc into a soup object
...
#print(tag.attrs) # See all the attributes via a dictionary
...
""" Multi-valued Attributes. Use the 4 elements from the list """
tag = soup.find_all('b')[3]
print(f"tag: {tag}")
